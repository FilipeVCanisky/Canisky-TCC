...
global. Além disso, a arquitetura unidimensional opera diretamente sobre os sinais de ECG no domínio temporal, dispensando a etapa de conversão 
...
Como desdobramento deste estudo e visando o aprimoramento contínuo dos sistemas de classificação de arritmias, são sugeridas as seguintes linhas de 
...
\begin{itemize}
    ...
    \item \textbf{Implementação em Hardware:} Portar o modelo CNN1D para sistemas embarcados, 
