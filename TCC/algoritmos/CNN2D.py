...
files_needed = ['X_train_2d.npy', 'y_train.npy', 'X_val_2d.npy', 'y_val.npy', 'X_test_2d.npy', 'y_test.npy']
...
print(f"Shape Validação: X={X_val.shape}, y={y_val.shape}")
...
checkpoint = ModelCheckpoint(
    'melhor_modelo_ecg_2d.keras', monitor='val_loss', save_best_only=True, mode='min', verbose=1
)
...
# melhor peso salvo
best_model = load_model('melhor_modelo_ecg_2d.keras')
