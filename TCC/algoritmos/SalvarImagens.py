...
if os.path.exists('X_val.npy'):
    ...
    # Converter
    X_val_img = converter_para_2d(X_val_raw, "VALIDAÇÃO")
    # Salvar
    np.save('X_val_2d.npy', X_val_img)
    print(f"Sucesso! 'X_val_2d.npy' salvo. Shape: {X_val_img.shape}")
    
    # Limpar memória
    del X_val_raw, X_val_img
else:
    print("ERRO: 'X_val.npy' não encontrado.")
